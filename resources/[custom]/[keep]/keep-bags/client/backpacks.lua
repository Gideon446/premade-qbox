...
function HandleBackpackLimits()
    ...
    if notAllowedToCarryMultipleBackpacks and total > maxAllowedBackpacks then
        --FreezePlayer()
        -- notify jab bola hai ek bag carry kar sakte ho tho kyu jada carry kar rahe ho
        Harmony.Player.Notify('jab bola hai ek bag carry kar sakte ho tho kyu jada carry kar rahe ho')
