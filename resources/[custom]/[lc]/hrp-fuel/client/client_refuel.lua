...
RegisterNetEvent('hrp-fuel:getPumpNozzle')
AddEventHandler('hrp-fuel:getPumpNozzle', function(fuelAmountPurchased, fuelTypePurchased)
    closeUI()
...
function returnNozzle()
    ...
    if not isRefuelling then
        ...
        if Config.ReturnNozzleRefund then
            ...
            TriggerServerEvent('hrp-fuel:returnNozzle', remainingFuelToRefuel, isElectric)
        end
    end
end
