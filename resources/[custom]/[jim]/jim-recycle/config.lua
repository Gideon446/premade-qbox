...
Config = {
	...
	RecycleAmounts = {
		...
		["Trade"] = {
			...
			{ amount = 10, itemGive = 3, Min = 8, Max = 10, },
			{ amount = 50, itemGive = 6, Min = 40, Max = 50, },
			{ amount = 100, itemGive = 8, Min = 60, Max = 70, },
			-- { amount = 1000, itemGive = 8, Min = 500, Max = 550, },
		},
	}
}

Config.chancePistol = 1  -- mean 2% chance 
Config.chanceLockpick = 10 -- 6 %
Config.lockpickamount = math.random(1,2)
Config.lockpickitem = "houselockpick"
