if Config.ScrapyardSearching.Enable then if Config.Debug then print("^5Debug^7: ^2Loading^7: '^6Scrapyard Searching^7'") end
	...
	--Dumpster Third Eye
    exports.ox_target:addModel(Config.ScrapyardSearching.models, {
        {
            name = "scrapyard_search",
            icon = "fas fa-dumpster",
            label = Loc[Config.Lan].target["search"],
            onSelect = function(data)
                TriggerEvent("jim-recycle:Scrap:Search", { entity = data.entity })
            end
        }
    }, 1.5)
