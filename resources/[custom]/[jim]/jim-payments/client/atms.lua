...
CreateThread(function()
	...
	if Config.useATM then
		exports.ox_target:addModel(Config.ATMModels, {
			{
				name = "atm_target",
				event = "jim-payments:Client:ATM:use",
				icon = "fas fa-money-check-alt",
				label = Loc[Config.Lan].target["atm"],
				id = "atm",
				distance = 1.5
			}
		})
		...
		for k,v in pairs(Config.WallATMLocations) do
			...
			exports.ox_target:addSphereZone({
				...
				options = {
					...
					-- You can uncomment and use this for transfers later:
					-- {
					--     event = "jim-payments:Client:ATM:use",
					--     icon = "fas fa-arrow-right-arrow-left",
					--     label = Loc[Config.Lan].target["transfer_money"],
					--     id = "transfer"
					-- }
				},
				distance = 1.5
		...
		for k,v in pairs(Config.ATMLocations) do
			...
			exports.ox_target:addSphereZone({
				...
				options = {
					...
					-- Uncomment below if you plan to use transfer option later
					-- {
					--     event = "jim-payments:Client:ATM:use",
					--     icon = "fas fa-arrow-right-arrow-left",
					--     label = Loc[Config.Lan].target["transfer_money"],
					...
					options = {
						{
							...
							label = Loc[Config.Lan].target["bank"],
							id = "bank"
						},
						{
							event = "jim-payments:Client:ATM:use",
							icon = "fas fa-arrow-right-arrow-left",
							label = Loc[Config.Lan].target["transfer"],
							id = "transfer"
						},
						{
							event = "jim-payments:Client:ATM:use",
							icon = "fas fa-money-check-dollar",
							label = Loc[Config.Lan].target["saving"],
							id = "savings"
						},
						{
							event = "jim-payments:Client:ATM:use",
							icon = "fas fa-building",
							label = Loc[Config.Lan].target["soc_saving"],
							id = "society",
							job = bossroles
						},
						{
							event = "jim-payments:Client:ATM:use",
							icon = "fas fa-arrow-right-arrow-left",
							label = Loc[Config.Lan].target["soc_trans"],
							id = "societytransfer",
							job = bossroles
						},
						{
							event = "jim-payments:Client:ATM:use",
							icon = "fas fa-building",
							label = Loc[Config.Lan].target["gang_acct"],
							id = "gang",
							gang = gangroles
						},
						{
							event = "jim-payments:Client:ATM:use",
							icon = "fas fa-arrow-right-arrow-left",
							label = Loc[Config.Lan].target["gang_trans"],
							id = "gangtransfer",
							gang = gangroles
						}
					},
