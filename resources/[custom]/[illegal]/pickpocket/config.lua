...
Config.CooldownTime = 30 * 1000        -- Cooldown time between pickpocketing the same NPC (in ms)
...
-- Items Settings
Config.EmptyPocketChance = 15          -- Chance of finding empty pockets (0-100)
...
Config.StealableItems = {
    ...
    { item = 'rolex', label = 'Rolex', min = 1, max = 1, chance = 50, value = '1x' },
    ...
    { item = 'lockpick', label = 'Lockpick', min = 1, max = 1, chance = 60, value = '1x' },
