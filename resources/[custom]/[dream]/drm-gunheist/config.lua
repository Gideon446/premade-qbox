...
-- Gun_client config
Config.hackingPosition = vector3(-1056.59, -232.38, 44.96) 	-- Where the computer hacking will take place
Config.drillTime = math.random(10000, 20000) 				-- time taken in drilling the crate --**NOTE INCREASE THIS TIME IF YOU HAVE ENABLED POLICE ALERT SO THAT POLICE CAN REACH TO THE CRATE IN TIME**--
Config.decryptTime = math.random(5000, 7500) 				-- time a key decryption will take
Config.requiredPolice = 0 									-- how many active police required to trigger the gun hesit
Config.enablePolice = true 									-- if you want to alert the police or not 
Config.policeAlert = 50  									-- here 50 means there is a 50% chance police will be alerted need enablepolice to be set to true

-- npc config
Config.npcSpawn = true 										-- if you want to spawn the guards that attact the player
Config['liGuards'] = { 										-- make sure npc coords are near hacking location
['npcguards'] = { 											-- you can add as many guards you want
{ coords = vector3(-1049.6, -242.23, 44.02), heading = 63.5, model = 's_m_m_prisguard_01' },
{ coords = vector3(-1049.6, -244.23, 44.02), heading = 46.35, model = 's_m_m_prisguard_01' },
        { coords = vector3(-1049.4, -236.55, 44.02), heading = 96.74, model = 's_m_m_prisguard_01' },
        { coords = vector3(-1056.57, -242.02, 44.02), heading = 156.29, model = 's_m_m_prisguard_01' },
        { coords = vector3(-1064.91, -243.55, 44.02), heading = 21.64, model = 's_m_m_prisguard_01' },
        { coords = vector3(-1075.2, -249.78, 44.02), heading = 51.64, model = 's_m_m_prisguard_01' },
        { coords = vector3(-1077.48, -245.19, 44.02), heading = 211.64, model = 's_m_m_prisguard_01' },
        { coords = vector3(-1082.28, -247.97, 44.02), heading = 121.64, model = 's_m_m_prisguard_01' },
    },
}
Config.npcWeapon = "weapon_assaultrifle" 					-- whaterver the weapon you want the npc to have
Config.DrillProp = 'prop_tool_drill'						-- don't change this is only for test
Config.RemoveHackKit = true									-- weather you want the hack kit to be removed after usage

-- hacking_client config
Config.lives = 2 											-- how many tries you have in hack default hack when using hack kit

-- gun_server config
Config.dropItems =  { 										-- you can add many as you want to but in the same format
	{itemName = "weapon_ceramicpistol", label = "Pistol", chance = 30},	
	{itemName = "weapon_snspistol", label = "SNS Pistol", chance = 35},
	{itemName = "weapon_heavypistol", label = "Heavy Pistol", chance = 50},
}
Config.drill = "drill_gh" 									-- you can chage the drill to 'drill' if you want to use default one
Config.multipleReward = 3  									-- how many rewards you want the player to get

-- minigames
Config.hackingMinigame = 'ox_lib'							-- mhacking, ps-ui, ox_lib [ can add custom in client/editable.lua ]

-- cooldown and timer config
Config.UseDreamCityStatus = true 							-- if you want to make script sync with city status [ no one will be able to start the hesit until citystatus is set to city safe ]
Config.SafeStatusCode = 'safe'								-- change this if you have changed the citysafe stuts in drm-citystatus script
Config.AutoCooldown = true									-- only works when using Config.UseDreamCityStatus [ this will set city status to cooldown automatically when hesit is started ]
Config.heistCooldown = 60	 								-- time in seconds

-- notify setting
Config.Notify = 'dream'										-- qb, dream 
