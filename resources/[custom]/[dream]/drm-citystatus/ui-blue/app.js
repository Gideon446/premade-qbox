    ...
    if (event.data.action == "openlist") {
        ...
        for (let l in list) {
            ...
            switch(l) {
                ...
                case "honhold": icon = "fa-pause-circle"; description = "High Alert"; break;
            ...
            $(".tb-pop").append(
                `<button class="control-button ${isActive} ${isDisabled}" data-ptype="${l}">
                    <i class="fas ${icon} text-3xl text-blue-500 mb-4"></i>
...
$(document).ready(function() {
    ...
    $('#themeToggle').on('click', function() {
        ...
        $(this).html(`<i class="fas ${isDark ? 'fa-moon' : 'fa-sun'} text-blue-400 text-xl"></i>`);
        localStorage.setItem('theme', isDark ? 'dark' : 'light');
    });

    if (localStorage.getItem('theme') === 'dark') {
        $('body').addClass('dark-theme');
        $('#themeToggle').html('<i class="fas fa-moon text-blue-400 text-xl"></i>');
    }
