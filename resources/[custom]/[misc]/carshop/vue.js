  ...
  methods: {
    ...
    selectCar(index) {
      ...
      if (this.selectedCar && this.selectedCar.model) {
        ...
        $.post('https://carshop/action', JSON.stringify({
          action: 'view-car',
    ...
    confirmTransaction() {
      ...
      if (playerHasEnoughMoney) {
        $.post('https://carshop/purchase-car', JSON.stringify({
          model: this.selectedCar.model,
    ...
    confirmTestDrive() {
      ...
      if (playerHasEnoughMoney) {
        $.post('https://carshop/TestDrive', JSON.stringify({
          model: this.selectedCar.model,
    ...
    updateCarColor(event, car) {
      try {
        ...
        if (carToUpdate && carToUpdate.model) {
          ...
          $.post('https://carshop/update-car-color', JSON.stringify({
            primaryColor: primaryColor,
            secondaryColor: secondaryColor
          }));
        }
